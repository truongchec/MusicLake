...
public class FloatLyricViewManager {
    ...
    private void createFloatLyricView(Context context) {
        try {
            ...
            LogUtil.d(TAG, "Start creating floating lyrics");
            if (mFloatLyricView == null) {
                LogUtil.d(TAG, "Create floating lyrics CreatemFloatLyricView");
                mFloatLyricView = new FloatLyricView(context);
                if (mFloatLyricViewParams == null) {
                    LogUtil.d(TAG, "Create floating lyrics CreatemFloatLyricViewParams");
            ...
            LogUtil.d(TAG, "Create floating lyrics");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
