...
class MyMusicFragment : BaseFragment<MyMusicPresenter>(), MyMusicContract.View {
    ...
    public override fun initViews() {
      ...
      //  downloadView.visibility = if (BuildConfig.HAS_DOWNLOAD) View.VISIBLE else View.GONE
        ...
        //初始化歌单Tab
        playlistTab.addTab(playlistTab.newTab().setText("Playlist").setTag(Constants.PLAYLIST_LOCAL_ID))
      //  playlistTab.addTab(playlistTab.newTab().setText("Online playlist").setTag(Constants.PLAYLIST_CUSTOM_ID))
     //   playlistTab.addTab(playlistTab.newTab().setText("Netease playlist").setTag(Constants.PLAYLIST_WY_ID))
