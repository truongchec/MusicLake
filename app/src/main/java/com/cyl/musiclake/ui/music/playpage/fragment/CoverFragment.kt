...
class CoverFragment : BaseFragment<BasePresenter<BaseContract.BaseView>>() {
    ...
    fun setImageBitmap(bm: Bitmap?) {
        ...
        LogUtil.d(TAG, "coverView =${civ_cover == null} rootView =${rootView == null} Set upBitmap bm =${bm == null}")
        if (currentBitmap == null) {
            LogUtil.d(TAG, "civ_cover2 Set upBitmap")
    ...
    fun initAlbumPic() {
        ...
        objectAnimator1 = ObjectAnimator.ofFloat(cover2View, "scaleX", 1f, 0.7f).apply {
            ...
            addListener(object : Animator.AnimatorListener {
                override fun onAnimationEnd(animation: Animator?) {
                    LogUtil.d("objectAnimator", "objectAnimator1 End of animation")
                }
                ...
                override fun onAnimationStart(animation: Animator?) {
                    ...
                    LogUtil.d("objectAnimator", "objectAnimator1 Animation start")
                }
        ...
        objectAnimator3 = ObjectAnimator.ofFloat(coverView, "alpha", 0f, 1F).apply {
            ...
            addListener(object : Animator.AnimatorListener {
                ...
                override fun onAnimationStart(animation: Animator?) {
                    LogUtil.d("objectAnimator", "objectAnimator2 Animation start")
                }
